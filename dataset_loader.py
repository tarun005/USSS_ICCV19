...
# class BDDataset(SegmentationDataset):
...
#     def __init__(self, root, subset='train', transform=None, file_path=False, num_images=None):
#         self.d_idx = 'BDD'
#         super(BDDataset, self).__init__(root, subset,  
#                 img_path = 'seg/images', label_path='seg/labels', pattern='*',
#                 img_suffix = '.jpg' , label_suffix='_train_id.png', transform=transform, file_path=file_path, num_images=num_images)


# class MVDataset(SegmentationDataset):

#     num_classes = 65
#     label_names = ['animal--bird', 'animal--ground-animal', 'construction--barrier--curb', 'construction--barrier--fence', 'construction--barrier--guard-rail', 'construction--barrier--other-barrier', 'construction--barrier--wall', 'construction--flat--bike-lane', 'construction--flat--crosswalk-plain', 'construction--flat--curb-cut', 'construction--flat--parking', 'construction--flat--pedestrian-area', 'construction--flat--rail-track', 'construction--flat--road', 'construction--flat--service-lane', 'construction--flat--sidewalk', 'construction--structure--bridge', 'construction--structure--building', 'construction--structure--tunnel', 'human--person', 'human--rider--bicyclist', 'human--rider--motorcyclist', 'human--rider--other-rider', 'marking--crosswalk-zebra', 'marking--general', 'nature--mountain', 'nature--sand', 'nature--sky', 'nature--snow', 'nature--terrain', 'nature--vegetation', 'nature--water', 'object--banner', 'object--bench', 'object--bike-rack', 'object--billboard', 'object--catch-basin', 'object--cctv-camera', 'object--fire-hydrant', 'object--junction-box', 'object--mailbox', 'object--manhole', 'object--phone-booth', 'object--pothole', 'object--street-light', 'object--support--pole', 'object--support--traffic-sign-frame', 'object--support--utility-pole', 'object--traffic-light', 'object--traffic-sign--back', 'object--traffic-sign--front', 'object--trash-can', 'object--vehicle--bicycle', 'object--vehicle--boat', 'object--vehicle--bus', 'object--vehicle--car', 'object--vehicle--caravan', 'object--vehicle--motorcycle', 'object--vehicle--on-rails', 'object--vehicle--other-vehicle', 'object--vehicle--trailer', 'object--vehicle--truck', 'object--vehicle--wheeled-slow', 'void--car-mount', 'void--ego-vehicle']
#     color_map   = np.array([[165, 42, 42], [0, 192, 0], [196, 196, 196], [190, 153, 153], [180, 165, 180], [90, 120, 150], [102, 102, 156], [128, 64, 255], [140, 140, 200], [170, 170, 170], [250, 170, 160], [96, 96, 96], [230, 150, 140], [128, 64, 128], [110, 110, 110], [244, 35, 232], [150, 100, 100], [70, 70, 70], [150, 120, 90], [220, 20, 60], [255, 0, 0], [255, 0, 100], [255, 0, 200], [200, 128, 128], [255, 255, 255], [64, 170, 64], [230, 160, 50], [70, 130, 180], [190, 255, 255], [152, 251, 152], [107, 142, 35], [0, 170, 30], [255, 255, 128], [250, 0, 30], [100, 140, 180], [220, 220, 220], [220, 128, 128], [222, 40, 40], [100, 170, 30], [40, 40, 40], [33, 33, 33], [100, 128, 160], [142, 0, 0], [70, 100, 150], [210, 170, 100], [153, 153, 153], [128, 128, 128], [0, 0, 80], [250, 170, 30], [192, 192, 192], [220, 220, 0], [140, 140, 20], [119, 11, 32], [150, 0, 255], [0, 60, 100], [0, 0, 142], [0, 0, 90], [0, 0, 230], [0, 80, 100], [128, 64, 64], [0, 0, 110], [0, 0, 70], [0, 0, 192], [32, 32, 32], [120, 10, 10]], dtype=np.uint8)
...
#         self.images_root = f"{root}/{subset}/images/"
#         self.labels_root = f"{root}/{subset}/labels/"
        

#         self.image_paths = glob.glob(f'{self.images_root}/*.jpg')
#         self.label_paths = [ img.replace(self.images_root, self.labels_root).replace('.jpg', '.png') for img in self.image_paths  ]

#         self.image_paths = self.image_paths[:7000]
#         self.label_paths = self.label_paths[:7000]
